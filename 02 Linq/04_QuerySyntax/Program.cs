    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IEnumerable<Test> result1 = from t in data.Test
                                        where t.TE_Class == "4EHIF" && t.TE_Teacher == "ZUM"
                                        select t;
            ...
            IEnumerable<Lesson> result2 = from l in data.Lesson
                                          where l.L_Teacher == "FZ" && l.L_Class == "3BHIF"
            ...
            var result4 = from t in data.Teacher
                          where t.Tests.Any(te => te.TE_Subject == "NW2")
                          select new
                          {
                              TeacherId = t.T_ID,
                              TeacherName = $"{t.T_Lastname} {t.T_Firstname}"
                          };
            ...
            var result6 = from t in data.Test
                          where t.TE_Date.DayOfWeek == DayOfWeek.Monday && 
                                t.TE_ClassNavigation.C_ClassTeacher == "SZ"
                          select new
                          {
                              Class = t.TE_Class,
            ...
            string kv = data.Schoolclass.SingleOrDefault(sc => sc.C_ID == "3AHIF").C_ClassTeacher;
            ...
            var result8 = from l in data.Lesson
                          where l.L_ClassNavigation.C_Department == "HIF" &&
                                l.L_Day == 2 && l.L_HourNavigation.P_From.TimeOfDay > new TimeSpan(17, 0, 0)
                          select new
                          {
                              Class = l.L_Class,
                              Subject = l.L_Subject,
                              Teacher = l.L_TeacherNavigation.T_Lastname,
            ...
            var result10 = (from t in data.Teacher
                           where t.T_ID == "SZ"
                           select new
                           {
                               ID = t.T_ID,
